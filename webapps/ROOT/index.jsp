...
<p>
會員帳號 :
<input type="text" name="M_a_number" id="M_a_number" maxlength="12" class="form-control" placeholder="輸入帳號" required /></p>
	<p>
	會員密碼 :<input type="password" name="M_password" id="M_password" maxlength="12" class="form-control" placeholder="輸入密碼" required /></p>
	</fieldset>
<p>
	<input type="submit" name="button" id="button" value="確認送出" class="btn btn-lg btn-primary btn-block" />	<h1 class="errmsg">${loginerror}</h1>
										</ul>
									</div>
								</li>
							</ul>
					...
					<section id="banner">
						<div class="inner">
							...
							<ul class="actions special">
								<li><a href="registerInfo.jsp" class="button primary">註冊會員</a></li>
							</ul>
						</div>
